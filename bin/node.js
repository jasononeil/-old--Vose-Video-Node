...
var server = server || {}
server.VoseProductionNode = $hxClasses["server.VoseProductionNode"] = function() { }
server.VoseProductionNode.__name__ = ["server","VoseProductionNode"];
server.VoseProductionNode.main = function() {
	var server = js.Node.http.createServer(server.VoseProductionNode.handleRequest);
	server.listen(1337,"localhost");
	haxe.Log.trace("Server running at http://127.0.0.1:1337/",{ fileName : "VoseProductionNode.hx", lineNumber : 11, className : "server.VoseProductionNode", methodName : "main"});
}
server.VoseProductionNode.handleRequest = function(req,res) {
	var arg = req.url.substr(1);
	haxe.Log.trace("Try launch: " + arg,{ fileName : "VoseProductionNode.hx", lineNumber : 17, className : "server.VoseProductionNode", methodName : "handleRequest"});
	js.Node.childProcess.spawn(arg,[]);
	res.setHeader("Content-Type","text/plain");
	res.writeHead(200);
	res.end("Hello Haxe World\n");
}
server.VoseProductionNode.prototype = {
	__class__: server.VoseProductionNode
}
...
server.VoseProductionNode.main()