...
server.api.Launcher = $hxClasses["server.api.Launcher"] = function() {
};
server.api.Launcher.__name__ = ["server","api","Launcher"];
server.api.Launcher.prototype = {
