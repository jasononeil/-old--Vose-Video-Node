...
dtx.Widget = $hxClasses["dtx.Widget"] = function(template) {
	dtx.DOMCollection.call(this);
	var q = dtx.Tools.parse(template);
	this.collection = q.collection;
};
dtx.Widget.__name__ = ["dtx","Widget"];
dtx.Widget.__super__ = dtx.DOMCollection;
dtx.Widget.prototype = $extend(dtx.DOMCollection.prototype,{
	__class__: dtx.Widget
});
app.author.AuthorView = $hxClasses["app.author.AuthorView"] = function(c) {
	dtx.Widget.call(this,app.author.AuthorView.tpl);
	this.controller = c;
...
app.author.AuthorView.__super__ = dtx.Widget;
app.author.AuthorView.prototype = $extend(dtx.Widget.prototype,{
	controller: null
...
app.copy.CopyView = $hxClasses["app.copy.CopyView"] = function(c) {
	dtx.Widget.call(this,app.copy.CopyView.tpl);
	this.controller = c;
...
app.copy.CopyView.__super__ = dtx.Widget;
app.copy.CopyView.prototype = $extend(dtx.Widget.prototype,{
	controller: null
...
app.edit.EditView = $hxClasses["app.edit.EditView"] = function(c) {
	dtx.Widget.call(this,app.edit.EditView.tpl);
	this.controller = c;
...
app.edit.EditView.__super__ = dtx.Widget;
app.edit.EditView.prototype = $extend(dtx.Widget.prototype,{
	controller: null
...
app.project.ProjectController.prototype = {
	view: null
	,list: function() {
		haxe.Log.trace("list",{ fileName : "ProjectController.hx", lineNumber : 29, className : "app.project.ProjectController", methodName : "list"});
		client.Client.showView(this.view);
	}
	,read: function(id) {
		haxe.Log.trace("read " + id,{ fileName : "ProjectController.hx", lineNumber : 42, className : "app.project.ProjectController", methodName : "read"});
	}
	,create: function() {
		var me = this;
		haxe.Log.trace("create",{ fileName : "ProjectController.hx", lineNumber : 48, className : "app.project.ProjectController", methodName : "create"});
		...
		dtx.collection.EventManagement.on(form,"submit",function(e) {
			...
			app.project.ProjectController.projectAPI.create(newProject,function(e1) {
				haxe.Log.trace("Added new project!",{ fileName : "ProjectController.hx", lineNumber : 55, className : "app.project.ProjectController", methodName : "create"});
				me.list();
			});
		});
	}
	,update: function(id) {
		haxe.Log.trace("update " + id,{ fileName : "ProjectController.hx", lineNumber : 64, className : "app.project.ProjectController", methodName : "update"});
	}
	,archive: function(id) {
		haxe.Log.trace("archive " + id,{ fileName : "ProjectController.hx", lineNumber : 95, className : "app.project.ProjectController", methodName : "archive"});
	}
	,__class__: app.project.ProjectController
}
app.project.ProjectView = $hxClasses["app.project.ProjectView"] = function(c) {
	dtx.Widget.call(this,app.project.ProjectView.tpl);
	this.controller = c;
...
app.project.ProjectView.__super__ = dtx.Widget;
app.project.ProjectView.prototype = $extend(dtx.Widget.prototype,{
	controller: null
	,form: null
	,listProjects: function(list) {
		...
		table.addAction("View",this.testAction.$bind(this),autoform.ui.ButtonType.Primary);
		table.addAction("Edit",($_=this.controller,$_.update.$bind($_)));
...
app.slide.SlideView = $hxClasses["app.slide.SlideView"] = function(c) {
	dtx.Widget.call(this,app.slide.SlideView.tpl);
	this.controller = c;
...
app.slide.SlideView.__super__ = dtx.Widget;
app.slide.SlideView.prototype = $extend(dtx.Widget.prototype,{
	controller: null
...
app.video.VideoController.prototype = {
	...
	,update: function(name) {
		...
		app.video.VideoController.videoAPI.read(name,function(video) {
			...
			dtx.collection.EventManagement.on(me.view.form,"submit",function(e) {
				e.preventDefault();
...
app.video.VideoView = $hxClasses["app.video.VideoView"] = function(c) {
	dtx.Widget.call(this,app.video.VideoView.tpl);
	this.controller = c;
...
app.video.VideoView.__super__ = dtx.Widget;
app.video.VideoView.prototype = $extend(dtx.Widget.prototype,{
	controller: null
	,form: null
	,list: function(list) {
		dtx.collection.DOMManipulation.empty(this);
	...
	,testAction: function(id) {
		haxe.Log.trace(id,{ fileName : "VideoView.hx", lineNumber : 39, className : "app.video.VideoView", methodName : "testAction"});
	}
	,renderForm: function() {
		dtx.collection.DOMManipulation.empty(this);
...
autoform.AbstractField = $hxClasses["autoform.AbstractField"] = function(html) {
	dtx.Widget.call(this,html);
};
autoform.AbstractField.__name__ = ["autoform","AbstractField"];
autoform.AbstractField.__super__ = dtx.Widget;
autoform.AbstractField.prototype = $extend(dtx.Widget.prototype,{
	get: function() {
...
autoform.AutoForm = $hxClasses["autoform.AutoForm"] = function(c,formID) {
	dtx.Widget.call(this,"<form></form>");
	if(formID == null) {
...
autoform.AutoForm.__super__ = dtx.Widget;
autoform.AutoForm.prototype = $extend(dtx.Widget.prototype,{
	formID: null
	,classval: null
	,rtti: null
	,meta: null
...
autoform.ui.Button.__super__ = dtx.Widget;
autoform.ui.Button.prototype = $extend(dtx.Widget.prototype,{
	type: null
	,setType: function(t) {
	...
	,__properties__: $extend(dtx.Widget.prototype.__properties__,{set_type:"setType"})
});
...
autoform.ui.TextField = $hxClasses["autoform.ui.TextField"] = function(field) {
	...
	dtx.collection.ElementManipulation.setAttr(dtx.collection.ElementManipulation.setAttr(dtx.collection.ElementManipulation.setAttr(dtx.collection.Traversing.find(this,"input"),"type","text"),"id",field.fullID),"placeholder",field.placeholder);
	dtx.collection.ElementManipulation.setAttr(dtx.collection.ElementManipulation.setText(dtx.collection.Traversing.find(this,"label"),field.title),"for",field.fullID);
	if(field.description != "") dtx.collection.ElementManipulation.addClass(dtx.collection.ElementManipulation.setText(dtx.collection.Traversing.find(this,"span"),field.description),"help-inline");
};
...
client.ui.basic.Table = $hxClasses["client.ui.basic.Table"] = function(type,list) {
	dtx.Widget.call(this,"<table></table>");
	this.fields = new Hash();
	this.type = type;
	this.createTable();
...
client.ui.basic.Table.__super__ = dtx.Widget;
client.ui.basic.Table.prototype = $extend(dtx.Widget.prototype,{
	type: null
	,fields: null
	,thead: null
	,tbody: null
	,createTable: function() {
		...
		while(_g < _g1.length) {
			var field = _g1[_g];
			++_g;
			haxe.Log.trace("I should check metadata here",{ fileName : "Table.hx", lineNumber : 42, className : "client.ui.basic.Table", methodName : "createTable"});
			if(field != "insert") {
...
client.ui.basic.ActionTable.prototype = $extend(client.ui.basic.Table.prototype,{
	...
	,addAction: function(label,action,type) {
		var $it0 = dtx.single.Traversing.find(this.tbody,"tr").collection.iterator();
		while( $it0.hasNext() ) {
			var tr = $it0.next();
...
client.ui.basic.Link.__super__ = dtx.Widget;
client.ui.basic.Link.prototype = $extend(dtx.Widget.prototype,{
	__class__: client.ui.basic.Link
});
if(!client.ui.menu) client.ui.menu = {}
client.ui.menu.Menu = $hxClasses["client.ui.menu.Menu"] = function() {
	dtx.Widget.call(this,"<ul></ul>");
	dtx.collection.ElementManipulation.addClass(this,"menu");
	this.items = new Hash();
};
client.ui.menu.Menu.__name__ = ["client","ui","menu","Menu"];
client.ui.menu.Menu.__super__ = dtx.Widget;
client.ui.menu.Menu.prototype = $extend(dtx.Widget.prototype,{
	items: null
...
client.ui.menu.MenuItem.__super__ = dtx.Widget;
client.ui.menu.MenuItem.prototype = $extend(dtx.Widget.prototype,{
	a: null
	,id: null
	,text: null
	,setID: function(id) {
...
client.ui.menu.NavBar.__super__ = dtx.Widget;
client.ui.menu.NavBar.prototype = $extend(dtx.Widget.prototype,{
	menu: null
	,__class__: client.ui.menu.NavBar
});
dtx.DOMType = $hxClasses["dtx.DOMType"] = function() { }
dtx.DOMType.__name__ = ["dtx","DOMType"];
dtx.DOMType.prototype = {
	__class__: dtx.DOMType
}
dtx.Tools = $hxClasses["dtx.Tools"] = function() {
};
dtx.Tools.__name__ = ["dtx","Tools"];
dtx.Tools.__properties__ = {get_window:"get_window",get_document:"get_document"}
...
dtx.collection.DOMManipulation.appendTo = function(children,parentNode,parentCollection) {
	if(parentNode != null) dtx.single.DOMManipulation.append(parentNode,null,children); else if(parentCollection != null) dtx.collection.DOMManipulation.append(parentCollection,null,children);
	return children;
}
...
dtx.collection.DOMManipulation.beforeThisInsert = function(target,contentNode,contentCollection) {
	if(contentNode != null) dtx.single.DOMManipulation.insertThisBefore(contentNode,null,target); else if(contentCollection != null) dtx.collection.DOMManipulation.insertThisBefore(contentCollection,null,target);
	return target;
}
dtx.collection.DOMManipulation.afterThisInsert = function(target,contentNode,contentCollection) {
	if(contentNode != null) dtx.single.DOMManipulation.insertThisAfter(contentNode,null,target); else if(contentCollection != null) dtx.collection.DOMManipulation.insertThisAfter(contentCollection,null,target);
	return target;
}
...
dtx.collection.DOMManipulation.prototype = {
	__class__: dtx.collection.DOMManipulation
}
...
dtx.collection.ElementManipulation.prototype = {
	__class__: dtx.collection.ElementManipulation
}
...
dtx.collection.EventManagement.on = function(targetCollection,eventType,listener) {
...
dtx.collection.EventManagement.one = function(targetCollection,eventType,listener) {
	var $it0 = targetCollection.collection.iterator();
	while( $it0.hasNext() ) {
		var target = $it0.next();
...
dtx.collection.EventManagement.prototype = {
	__class__: dtx.collection.EventManagement
}
...
dtx.collection.Style.prototype = {
	__class__: dtx.collection.Style
}
...
dtx.collection.Traversing.prototype = {
	__class__: dtx.collection.Traversing
}
		...
		if(targetCollection != null) {
			...
			while( $it0.hasNext() ) {
				...
				if(next != null) {
					...
					parent.insertBefore(childToInsert,next1);
...
dtx.single.DOMManipulation.prototype = {
	__class__: dtx.single.DOMManipulation
}
...
dtx.single.ElementManipulation.prototype = {
	__class__: dtx.single.ElementManipulation
}
...
dtx.single.EventManagement.triggerHandler = function(target,event) {
	return target;
}
...
dtx.single.EventManagement.mousedown = function(target,listener) {
	return dtx.single.EventManagement.on(target,"mousedown",listener);
}
dtx.single.EventManagement.mouseenter = function(target,listener) {
	return dtx.single.EventManagement.on(target,"mouseover",listener);
}
dtx.single.EventManagement.mouseleave = function(target,listener) {
	return dtx.single.EventManagement.on(target,"mouseout",listener);
}
dtx.single.EventManagement.mousemove = function(target,listener) {
	return dtx.single.EventManagement.on(target,"mousemove",listener);
}
...
dtx.single.EventManagement.mouseup = function(target,listener) {
	return dtx.single.EventManagement.on(target,"mouseup",listener);
}
dtx.single.EventManagement.keydown = function(target,listener) {
	return dtx.single.EventManagement.on(target,"keydown",listener);
}
dtx.single.EventManagement.keypress = function(target,listener) {
	return dtx.single.EventManagement.on(target,"keypress",listener);
}
dtx.single.EventManagement.keyup = function(target,listener) {
	return dtx.single.EventManagement.on(target,"keyup",listener);
}
dtx.single.EventManagement.hover = function(target,listener1,listener2) {
	dtx.single.EventManagement.on(target,"mouseover",listener1);
	if(listener2 == null) dtx.single.EventManagement.on(target,"mouseout",listener1); else dtx.single.EventManagement.on(target,"mouseout",listener2);
	return target;
}
dtx.single.EventManagement.submit = function(target,listener) {
	return dtx.single.EventManagement.on(target,"submit",listener);
}
...
dtx.single.EventManagement.blur = function(target,listener) {
	return dtx.single.EventManagement.on(target,"blur",listener);
}
dtx.single.EventManagement.change = function(target,listener) {
	return dtx.single.EventManagement.on(target,"change",listener);
}
dtx.single.EventManagement.click = function(target,listener) {
	return dtx.single.EventManagement.on(target,"click",listener);
}
dtx.single.EventManagement.dblclick = function(target,listener) {
	return dtx.single.EventManagement.on(target,"dblclick",listener);
}
dtx.single.EventManagement.focus = function(target,listener) {
	return dtx.single.EventManagement.on(target,"focus",listener);
}
dtx.single.EventManagement.focusIn = function(target,listener) {
	return dtx.single.EventManagement.on(target,"focusIn",listener);
}
dtx.single.EventManagement.focusOut = function(target,listener) {
	return dtx.single.EventManagement.on(target,"focusOut",listener);
}
dtx.single.EventManagement.resize = function(target,listener) {
	return dtx.single.EventManagement.on(target,"resize",listener);
}
dtx.single.EventManagement.scroll = function(target,listener) {
	return dtx.single.EventManagement.on(target,"scroll",listener);
}
dtx.single.EventManagement.select = function(target,listener) {
	return dtx.single.EventManagement.on(target,"select",listener);
}
dtx.single.EventManagement.load = function(target,listener) {
	return dtx.single.EventManagement.on(target,"load",listener);
}
dtx.single.EventManagement.unload = function(target,listener) {
	return dtx.single.EventManagement.on(target,"unload",listener);
}
dtx.single.EventManagement.error = function(target,listener) {
	return dtx.single.EventManagement.on(target,"error",listener);
}
dtx.single.EventManagement.ready = function(target,listener) {
	return dtx.single.EventManagement.on(target,"ready",listener);
}
dtx.single.EventManagement.prototype = {
	__class__: dtx.single.EventManagement
}
...
dtx.single.Style.prototype = {
	__class__: dtx.single.Style
}
...
dtx.single.Traversing.descendants = function(node,elementsOnly) {
	if(elementsOnly == null) elementsOnly = true;
	var descendantList = new dtx.DOMCollection();
	var $it0 = dtx.single.Traversing.children(node,elementsOnly).collection.iterator();
	while( $it0.hasNext() ) {
		var child = $it0.next();
		{
			if(child != null) {
...
dtx.single.Traversing.prototype = {
	__class__: dtx.single.Traversing
}
var erazor = erazor || {}
...
pushstate.PushState.stripURL = function(path) {
	if(path.substr(0,pushstate.PushState.basePath.length) == pushstate.PushState.basePath) path = path.substr(pushstate.PushState.basePath.length);
	return path;
}
...
app.author.AuthorView.tpl = "<div>This is my copy template!</div>";
app.copy.CopyView.tpl = "<div>\n\t\n\t\n</div>";
app.edit.EditView.tpl = "<div>This is my copy template!</div>";
client.Client.conn = haxe.remoting.HttpAsyncConnection.urlConnect("http://localhost:1337");
app.project.ProjectController.__meta__ = { fields : { list : { route : ["projects/"]}, read : { route : ["projects/[]/"]}, create : { route : ["projects/new/"]}, update : { route : ["projects/{}/edit/"]}, archive : { route : ["projects/{}/archive/"]}}};
app.project.ProjectController.projectAPI = new app.project.ProjectAPIProxy(client.Client.conn);
app.project.ProjectView.tpl = "<div>\n    <div class=\"row-fluid\">\n        <div class=\"span8\">\n            <h1 class=\"pull-left\">All Projects</h1>\n            <a href=\"/projects/new/\" rel=\"pushstate\" class=\"btn btn-primary pull-right\">New Project</a>\n            <table class=\"table table-bordered table-striped\">\n                <thead>\n                    <tr>\n                        <th>Name</th>\n                        <th>Videos Ready</th>\n                        <th>Actions</th>\n                    </tr>\n                </thead>\n                <tbody>\n                    <tr>\n                        <td>PC301</td>\n                        <td>\n\n                            <div class=\"progress progress-success\">\n                                <div class=\"bar\" style=\"width: 60%;\">6/10</div>\n                            </div>\n                        </td>\n                        <td>\n                            <div class=\"btn-group pull-right\">\n                                <button class=\"btn\">Open</button>\n                                <button class=\"btn dropdown-toggle\" data-toggle=\"dropdown\">\n                                    <span class=\"caret\"></span>\n                                </button>\n                                <ul class=\"dropdown-menu\">\n                                    <li><a href=\"#\">Edit</a></li>\n                                    <li><a href=\"#\">Archive</a></li>\n                                </ul>\n                            </div>\n                        </td>\n                    </tr>\n                    <tr>\n                        <td>NT301</td>\n                        <td>\n\n                            <div class=\"progress progress-success\">\n                                <div class=\"bar\" style=\"width: 20%;\">2/10</div>\n                            </div>\n                        </td>\n                        <td>\n                            <div class=\"btn-group pull-right\">\n                                <button class=\"btn\">Open</button>\n                                <button class=\"btn dropdown-toggle\" data-toggle=\"dropdown\">\n                                    <span class=\"caret\"></span>\n                                </button>\n                                <ul class=\"dropdown-menu\">\n                                    <li><a href=\"#\">Edit</a></li>\n                                    <li><a href=\"#\">Archive</a></li>\n                                </ul>\n                            </div>\n                        </td>\n                    </tr>\n                </tbody>\n            </table>\n            <h4 class=\"pull-left\">Archived Projects (6)</h4>\n            <button class=\"btn pull-right\">Show</button>\n            <table class=\"table table-bordered table-striped\">\n                <thead>\n                    <tr>\n                        <th>Name</th>\n                        <th>Videos Ready</th>\n                        <th>Actions</th>\n                    </tr>\n                </thead>\n                <tbody>\n                    <tr>\n                        <td>PC301</td>\n                        <td>\n\n                            <div class=\"progress progress-success\">\n                                <div class=\"bar\" style=\"width: 60%;\">6/10</div>\n                            </div>\n                        </td>\n                        <td>\n                            <div class=\"btn-group pull-right\">\n                                <button class=\"btn\">Open</button>\n                                <button class=\"btn dropdown-toggle\" data-toggle=\"dropdown\">\n                                    <span class=\"caret\"></span>\n                                </button>\n                                <ul class=\"dropdown-menu\">\n                                    <li><a href=\"#\">Edit</a></li>\n                                    <li><a href=\"#\">Un-Archive</a></li>\n                                </ul>\n                            </div>\n                        </td>\n                    </tr>\n                    <tr>\n                        <td>NT301</td>\n                        <td>\n\n                            <div class=\"progress progress-success\">\n                                <div class=\"bar\" style=\"width: 20%;\">2/10</div>\n                            </div>\n                        </td>\n                        <td>\n                            <div class=\"btn-group pull-right\">\n                                <button class=\"btn\">Open</button>\n                                <button class=\"btn dropdown-toggle\" data-toggle=\"dropdown\">\n                                    <span class=\"caret\"></span>\n                                </button>\n                                <ul class=\"dropdown-menu\">\n                                    <li><a href=\"#\">Edit</a></li>\n                                    <li><a href=\"#\">Archive</a></li>\n                                </ul>\n                            </div>\n                        </td>\n                    </tr>\n                </tbody>\n            </table>\n        </div>\n        <div class=\"span4\">\n            <h3>Welcome</h3>\n            <p>\n                This is an overview of all of your projects (for \n                instance, all units).  Each of these contains a bunch\n                of videos.  The progress bar represents how many videos\n                have been finished, out of how many there are total.\n            </p>\n            <p>\n                You can create a new Project by clicking the \"New\" button.\n            </p>\n        </div>\n    </div>\n    <p>Stuff goes here</p>\n</div>";
...
app.slide.SlideView.tpl = "<div>This is my copy template!</div>";
app.video.VideoController.__meta__ = { fields : { list : { route : ["videos"]}, read : { route : ["videos/{}/"]}, create : { route : ["videos/new/"]}, update : { route : ["videos/edit/{}/"]}, archive : { route : ["videos/archive/{}/"]}}};
app.video.VideoController.videoAPI = new app.video.VideoAPIProxy(client.Client.conn);
app.video.VideoView.tpl = "<div>This is my copy template!</div>";
